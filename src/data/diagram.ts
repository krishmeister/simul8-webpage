...
export const nodes: DiagramNode[] = [
  ...
  // ── Prediction & Simulation Engine (ensemble container + header + cards) ────
  {
    id: 'engine-group',
    variant: 'group',
    position: { x: 860, y: 876 },
    size: { w: 810, h: 508 },
    color: 'pink',
    z: 0,
    group: 'engines',
    groupSelect: true,
    title: 'Prediction & Simulation Engine ensemble',
    fullDescription:
      'The six engines and their header are one ensemble — a single team. Sub-task B dispatches each request to whichever members the calibration record says to trust, at the weights they have earned.',
  },
  {
    id: 'engine-header',
    variant: 'bar',
  ...
  },
  {
    ...
    tag: 'TSFM',
    tools: 'TimesFM · Chronos · Moirai · Lag-Llama',
    fullDescription:
  ...
  },
  {
    ...
    tools: 'DoWhy · EconML · CausalML · NOTEARS',
    badge: '+ Monte Carlo',
    fullDescription:
